  ...
  const text =
    language === "zh"
      ? {
          ...
          title: "把项目接进来，再开始自动推进",
          description:
            "先理解仓库，再进入编排。你可以先做新项目头脑风暴，或导入老项目，识别 TODO、计划文档、参考文档和脚本，再决定是否正式接入执行。",
          operatingMode: "当前定位",
          operatingModeValue: "本地优先、多 Agent、可审计开发控制台",
          alphaStatus: "阶段",
          ...
          intakeSubtitle: "决定项目边界、文档源、TODO 主清单和执行命令。",
          fleetTitle: "项目舰队",
          fleetSubtitle: "导入后的项目会在这里排队、运行和回写。",
          emptyProjects: "还没有项目。先在右侧创建新项目，或导入一个现有仓库。",
          active: "进行中",
          tasks: "任务",
          done: "已完成",
          waiting: "待人工",
